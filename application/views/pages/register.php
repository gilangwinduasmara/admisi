			...
			<div class="card card-custom">
				<div class="card-body">
					<form action="" method="POST">
						...
						<div class="form-group row align-items-center input-hp">
							<label class="col-md-3 col-form-label">No. HP</label>
							<div class="col-md-9">
								<input required class="form-control" type="phone" value="">
							</div>
						</div>
						<div class="form-group row align-items-center">
						...
						<div class="form-group row align-items-center">
							...
							<div class="col-md-9">
								<input required class="form-control" type="password" value="">
							</div>
						</div>
						<div class="form-group row align-items-center">
